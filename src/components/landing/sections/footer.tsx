        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2 text-zinc-900">
              <IconSolarPanel className="size-8 text-[#16a34a]" stroke={1.5} />
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex size-10 items-center justify-center rounded-full border border-zinc-200 text-[#16a34a] transition-colors hover:bg-zinc-50"
                aria-label="WhatsApp"
              >
            ...
            <ul className="space-y-2 text-sm text-zinc-600">
              {footerNavLinks.map((item) => (
                <li key={`${item.href}-${item.label}`}>
                  <a href={item.href} className="hover:text-[#16a34a]">
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-600">
              {footerSolutionLinks.map((label) => (
                <li key={label}>
                  <a href="#projetos" className="hover:text-[#16a34a]">
                    {label}
                  </a>
                </li>
              ))}
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-zinc-600">
                ...
                <li className="flex gap-2">
                  <IconMapPin className="mt-0.5 size-4 shrink-0 text-[#16a34a]" />
